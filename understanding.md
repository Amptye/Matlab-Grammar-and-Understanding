...
- 当数据结构是 **多维数组/z轴坐标写在左边的多维矩阵** 时，**<font color='red'>维度向左扩张</font>**，采用 **行优先**（如 NumPy，由于**维度向左扩张/升高**，所以NumPy的**第0维**是**最高维**，维度号与维度等级是相反的，维度号越小，维度越高）（此外还有，NumPy中维度从0开始计数，而Matlab中维度从1开始计数）
